...
void display1(void)
{
	...
	glClearColor(0.196078,0.8,0.196078,1.0);
  glClear(GL_COLOR_BUFFER_BIT);
	display_string(190,570,"Jain College Of Engineering And Technology Hubbali",1); 
	display_string(225,540,name3,1);
	display_string(390+10,470,"MENU",2);
  display_string(10,500,"Guided by:Prof.Rajeshwari Patil",2);
	...
	display_string(320,150+30,"PRESS SPACE BAR TO ENTER",2);
  display_string(10,130+30,"Project By:",2);
  display_string(10,110+30,"Sangameshwar B Jalihal          USN: 2JH21CS127",3);
  display_string(10,90+30,"Sumanth K Naganurmath          USN: 2JH21CS105",3);
  display_string(10,70+30,"Umesh Laxman Nayak              USN: 2JH21CS115",3);
